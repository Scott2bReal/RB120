...
# Solution:
#
# Upon instantiating a SecretFile object, a new SecurityLogger object would be
# created, and @log would be assigned to it. Whenever a client of the SecretFile
# class tries to access @data, the SecurityLogger#create_log_entry method would
# be called so that the @data access was recorded
