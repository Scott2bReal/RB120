...
# The issue in this code is that they forgot to include the Mailing module in
# the PostalService class definition. There is a method in the Ruby Core Library
# called send, so ruby was trying to invoke that method. Including the Mailing
# module solves the issue. The send method in Mailing should be renamed to be
# more specific, and to avoid overriding existing methods
