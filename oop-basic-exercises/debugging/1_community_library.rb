...
# To function correctly, this line could read like:
community_library.books.each(&:display_data)

# On the final line of the program, Book#display_data is being called on an
# Array object instead of a book object. The method needs to be called on each
# Book object in the library's books Array
